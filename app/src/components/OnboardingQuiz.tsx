...
const ROLES: Record<Role, RoleInfo> = {
  explorer:   { name: 'DeFi Explorer',     emoji: '🌱', title: 'The Curious Learner',   description: "Welcome — you're new here, and that's the best place to be. We'll start small, explain the why behind every step, and never push you faster than feels right.", color: '#10B981', strengths: ['Openness to learn', 'Low risk tolerance', 'Methodical approach'] },
  trader:     { name: 'Active Trader',      emoji: '📊', title: 'The Market Mover',      description: "You live for the chart. Quests lean into quick swaps, arbitrage windows, and timing — built for someone who already speaks the language of execution.", color: '#3B82F6', strengths: ['Fast execution', 'Market awareness', 'Risk comfort'] },
  strategist: { name: 'Yield Strategist',   emoji: '🎯', title: 'The Optimizer',         description: "If a basis point is on the table, you're picking it up. Expect quests that hunt yield across Marinade, Kamino, Drift, and friends.", color: '#F59E0B', strengths: ['Yield optimization', 'Protocol knowledge', 'Long-term thinking'] },
  analyst:    { name: 'On-Chain Analyst',    emoji: '🔍', title: 'The Data Detective',    description: "You read the chain like a book. Quests will lean on Helius, Birdeye, and explorer deep-dives — the data tells the story, you just translate it.", color: '#8B5CF6', strengths: ['Data-driven decisions', 'Research skills', 'Pattern recognition'] },
  architect:  { name: 'DeFi Architect',     emoji: '🏗️', title: 'The Protocol Builder',  description: "You're here for the lego pieces, not the candles. Quests push you across advanced primitives — flash loans, CPI chains, lending compositions.", color: '#EC4899', strengths: ['Technical depth', 'Protocol design', 'Composability thinking'] },
  hunter:     { name: 'Airdrop Hunter',     emoji: '🪂', title: 'The Early Adopter',     description: "Day-one energy. Your quests focus on fresh protocols, testnet activity, and the social signals that show up before the announcement.", color: '#14B8A6', strengths: ['Speed to new protocols', 'Risk appetite', 'Community radar'] },
  diamond:    { name: 'Diamond Hands',      emoji: '💎', title: 'The Patient Staker',    description: "You play the long game. Staking, restaking, compounding — quests that reward patience now and reward you again next month.", color: '#6366F1', strengths: ['Patience', 'Conviction', 'Compound thinking'] },
  degen:      { name: 'Full Degen',         emoji: '🦍', title: 'The Risk Embracer',     description: "5% APY isn't your story. You came for the volatility, and we won't water it down — quests will match your appetite (responsibly, on devnet, of course).", color: '#EF4444', strengths: ['Risk tolerance', 'Speed', 'FOMO resistance'] },
}
